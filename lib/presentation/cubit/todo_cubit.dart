...
class TodoState {
  ...
  TodoState({required this.status, required this.todos, this.errorMessage});
...
class TodoCubit extends Cubit<TodoState> {
  ...
  TodoCubit(this.addTodo, this.getTodo, this.updateTodo, this.deleteTodo)
  ...
  Future<void> loadTodos() async {
    ...
    result.fold(
      (failure) => emit(
        state.copyWith(status: TodoStatus.error, errorMessage: failure.message),
      ),
